...
void LAB2_init__(LAB2 *data__, BOOL retain) {
  __INIT_VAR(data__->MICRO,0,retain)
  ...
  __INIT_VAR(data__->_TMP_LE14_OUT,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->_TMP_LE3_OUT,__BOOL_LITERAL(FALSE),retain)
...
void LAB2_body__(LAB2 *data__) {
  ...
  __SET_VAR(data__->,_TMP_LE14_OUT,,LE__BOOL__INT(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)2,
    (INT)__GET_VAR(data__->MICRO,),
    (INT)600));
  __SET_VAR(data__->TP1.,IN,,__GET_VAR(data__->_TMP_LE14_OUT,));
  __SET_VAR(data__->TP1.,PT,,__time_to_timespec(1, 0, 10, 0, 0, 0));
  TP_body__(&data__->TP1);
  __SET_VAR(data__->,RELE,,__GET_VAR(data__->TP1.Q,));
  __SET_VAR(data__->TP3.,IN,,__GET_VAR(data__->_TMP_LE14_OUT,));
  __SET_VAR(data__->TP3.,PT,,__time_to_timespec(1, 0, 3, 0, 0, 0));
  TP_body__(&data__->TP3);
  __SET_VAR(data__->,LED3,,__GET_VAR(data__->TP3.Q,));
  __SET_VAR(data__->,_TMP_LE3_OUT,,LE__BOOL__INT(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)2,
    (INT)__GET_VAR(data__->MICRO,),
    (INT)800));
  __SET_VAR(data__->TP2.,IN,,__GET_VAR(data__->_TMP_LE3_OUT,));
  __SET_VAR(data__->TP2.,PT,,__time_to_timespec(1, 0, 6, 0, 0, 0));
  TP_body__(&data__->TP2);
  __SET_VAR(data__->,LED2,,__GET_VAR(data__->TP2.Q,));
  __SET_VAR(data__->,_TMP_LE6_OUT,,LE__BOOL__INT(
    ...
    (INT)__GET_VAR(data__->MICRO,),
    (INT)1000));
  __SET_VAR(data__->TP4.,IN,,__GET_VAR(data__->_TMP_LE6_OUT,));
  __SET_VAR(data__->TP4.,PT,,__time_to_timespec(1, 0, 9, 0, 0, 0));
  TP_body__(&data__->TP4);
  __SET_VAR(data__->,LED1,,__GET_VAR(data__->TP4.Q,));
